            ...
            for y in range(self._size[1]):
                if(( x == 7 or x == 8) and (y == 7 or y == 8)):
                    ...
                    self._grid[x][y] = Tile((x,y), TileType.start_box)
                        ...
                        or (x == 4 and (y == 0 or (y > 6 and y < 10))) \
                        or (x == 5 and (y == 0 or y == 8)) \
                        or (x == 6 and ((y >= 0 and y < 3) or (y > 5 and y < 9))) \
                        or (x == 7 and ((y > 1 and y < 7) or y == 9)) \
                        or (x == 8 and ((y > 1 and y < 5) or y == 6 or (y > 8 and y < 11))) \
                        or (x == 9 and ((y >= 0 and y < 3) or (y > 6 and y < 10) or (y > 10 and y < 14))) \
